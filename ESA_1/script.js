...
const xsAll = [];
let dataset = null; // {x:[], y:[], xTrain:[], yTrain:[], xTest:[], yTest:[], xTrainNoisy:[], yTrainNoisy:[], xTestNoisy:[], yTestNoisy:[]}
let models = {};
...
function generateDataset(N=100, noiseVar=0.05) {
  ...
  dataset = {x: xs, y: ys, xTrain, yTrain, xTest, yTest, xTrainNoisy, yTrainNoisy, xTestNoisy, yTestNoisy};
  plotData();
}
